...
<%@include file="navbar.jsp" %><br>
 ...
 <div class="container mt-5">
    ...
    for (Payment p : allPayments) {
        if ("SUCCESS".equalsIgnoreCase(p.getStatus())) {
            ...
            if (p.getCreatedAt() != null) {
                if (p.getCreatedAt().startsWith(todayStr)) {
                    todaysColl += amt;
                }
                if (p.getCreatedAt().startsWith(monthStr)) {
                    monthlyColl += amt;
                }
            }
        }
    ...
    <div class="row g-4 mb-4">
      <div class="col-md-4">
        <a href="payment_dashboard.jsp" class="text-decoration-none">
          <div class="card text-center p-3" style="background-color: #e2f0d9; border-color: #a8d08d;">
            <div class="card-body">
              <i class="fa-solid fa-indian-rupee-sign card-icons" style="color: #385723;"></i>
              <h5 class="card-title mt-3 fw-bold text-dark">Today's Collection</h5>
              <h3 class="fw-bold" style="color: #385723;">INR <%= String.format("%.2f", todaysColl) %></h3>
            </div>
          </div>
        </a>
      </div>
      <div class="col-md-4">
        <a href="payment_dashboard.jsp" class="text-decoration-none">
          <div class="card text-center p-3" style="background-color: #ddebf7; border-color: #9cc2e6;">
            <div class="card-body">
              <i class="fa-solid fa-calendar-days card-icons" style="color: #1f4e78;"></i>
              <h5 class="card-title mt-3 fw-bold text-dark">Monthly Collection</h5>
              <h3 class="fw-bold" style="color: #1f4e78;">INR <%= String.format("%.2f", monthlyColl) %></h3>
            </div>
          </div>
        </a>
      </div>
      <div class="col-md-4">
        <a href="payment_dashboard.jsp" class="text-decoration-none">
          <div class="card text-center p-3" style="background-color: #fff2cc; border-color: #ffd966;">
            <div class="card-body">
              <i class="fa-solid fa-chart-line card-icons" style="color: #7f6000;"></i>
              <h5 class="card-title mt-3 fw-bold text-dark">Total Collection</h5>
              <h3 class="fw-bold" style="color: #7f6000;">INR <%= String.format("%.2f", totalColl) %></h3>
            </div>
          </div>
        </a>
      </div>
